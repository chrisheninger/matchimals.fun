...
| `noCardFits` | No card left fits the board | Ya no encaja ninguna carta | Ya no encaja ninguna carta | Nenhuma carta mais se encaixa | Keine Karte passt mehr aufs Feld | Plus aucune carte ne peut être posée | Nessuna carta combacia più | おけるカードがなくなったよ | 더 놓을 수 있는 카드가 없어요 | 没有能放的牌了 |
| `share` | Share | Compartir | Compartir | Compartilhar | Teilen | Partager | Condividi | 共有 | 공유 | 分享 |
| `shareMessage` | I just won in Matchimals! {emoji} Play this cute card game — free, no ads, works offline! {url} | ¡Acabo de ganar en Matchimals! {emoji} Juega a este juego de cartas tan bonito: ¡gratis, sin anuncios y funciona sin internet! {url} | ¡Acabo de ganar en Matchimals! {emoji} Juega a este juego de cartas tan bonito: ¡gratis, sin anuncios y funciona sin internet! {url} | Acabei de vencer no Matchimals! {emoji} Jogue este jogo de cartas fofinho: grátis, sem anúncios e funciona offline! {url} | Ich habe gerade bei Matchimals gewonnen! {emoji} Spiel dieses niedliche Kartenspiel: kostenlos, ohne Werbung, funktioniert offline! {url} | Je viens de gagner à Matchimals ! {emoji} Joue à ce mignon jeu de cartes : gratuit, sans pub et ça marche hors ligne ! {url} | Ho appena vinto a Matchimals! {emoji} Gioca a questo tenero gioco di carte: gratis, senza pubblicità e funziona offline! {url} | Matchimalsで勝ったよ！{emoji} かわいいカードゲーム、無料・広告なし・オフラインでも遊べる！ {url} | 방금 Matchimals에서 이겼어요! {emoji} 귀여운 카드 게임, 무료에 광고 없고 오프라인에서도 돼요! {url} | 我刚在 Matchimals 里赢了！{emoji} 快来玩这个超可爱的卡牌游戏，免费、无广告、离线也能玩！{url} |
